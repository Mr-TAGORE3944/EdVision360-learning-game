...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase max-w-[200px] tracking-wide disabled:opacity-50 font-bold rounded-xl",
  {
    variants: {
      variant: {
        locked:
        ...
        sidebarOutline:
          "bg-sky-500/15 text-sky-500 border-sky-300 border-2 hover-500/20 transition-none",
      },
      size: {
